...
@Data
public class BatteryControllerWaveshare3S5AUPS extends BatteryControllerWaveshare {

    public BatteryControllerWaveshare3S5AUPS(MasterController masterController) throws IOException, I2CFactory.UnsupportedBusNumberException {
        super(masterController, 0x41);
